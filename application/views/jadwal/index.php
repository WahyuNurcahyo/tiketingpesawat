	...
	<div class="container-fluid mimin-wrapper bg-light-grey">
		...
		<div style="width: 100%;margin-top: 55px;">
			<div class="panel" style="width: 100%;">
				...
				<br>
				<center>
					Wahyu Nur Cahyo &#169; <script type='text/javascript'>var creditsyear = new Date();document.write(creditsyear.getFullYear());</script> <a expr:href='data:blog.homepageUrl'><data:blog.title/></a>. All rights reserved.
				</center>
			</div>
		</div>
		<!-- end: content -->
